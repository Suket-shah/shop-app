...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://flutter-update.firebaseio.com/products.json?auth=$authToken&$filterString'; // ?auth= checks authorization
    try {
      ...
      final favoriteData = json
          .decode(favoriteResponse.body); // this gets the data from the server
